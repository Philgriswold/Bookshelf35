...
namespace Bookshelf35.Controllers
{
    ...
    public class AuthorsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ApplicationUserId")] Author author)
        {
            if (id != author.Id)
            {
                return NotFound();
        ...
        private Task<ApplicationUser> GetCurrentUserAsync() => _userMananger.GetUserAsync(HttpContext.User);
    }
}
